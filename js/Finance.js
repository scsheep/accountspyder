var Finance = {
    ...
    $(function () {
        $.getJSON(realtimeQ, function (json) {
            sap.ui.getCore().setModel(new sap.ui.model.json.JSONModel(json.query.results.qoute),  "financeModel");
        }); //end CallBack
    });//End Anon
    },
    ...
    $(function(){
        $.getJSON(queryURL,function(json){
            sap.ui.getCore().setModel(new sap.ui.model.json.JSONModel(json.query.results.qoute),  "historicFinanceModel");
        });
    });
    }
